...
$string['pluginname'] = 'categorycreate';
$string['pluginname_desc'] = 'Create categories based on centrally held university data passed by integrations.';
...
$string['remotetablecatlev'] = 'Remote category levels table';
...
$string['remotetablecats'] = 'Remote categories table';
